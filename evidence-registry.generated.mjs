...
export const EVIDENCE_OUTPUTS = [
     ...
     * ------------------------------------------------------------------------- local ledgers
     *
     * THE FULL LEDGERS, and they are owned for a reason worth keeping. The two `marigold` sidecars
     ...
     *
     * A SINGLE-PACKAGE RUN DOES NOT USE IT and keeps writing `abloh-proposals-proofs.json` beside the
